...
def res3d_clstm_mobilenet(inputs, seq_len, weight_decay, clstm_type):
  # Res3D Block
  res3d_featmap = res3d(inputs, weight_decay)

  if clstm_type==SEPARABLE:
    # SeparableConvLSTM2D Block
    clstm2d_1 = keras.layers.SeparableConvLSTM2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='separableclstm2d_1')(res3d_featmap)
    clstm2d_2 = keras.layers.SeparableConvLSTM2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='separableclstm2d_2')(clstm2d_1)
  elif clstm_type==GROUP:
    # GroupConvLSTM2D Block
    clstm2d_1 = keras.layers.GroupConvLSTM2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='groupclstm2d_1', group_size=8)(res3d_featmap)
    clstm2d_2 = keras.layers.GroupConvLSTM2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='groupclstm2d_2', group_size=8)(clstm2d_1)
  elif clstm_type==SHUFFLE:
    # ShuffleConvLSTM2D Block
    clstm2d_1 = keras.layers.ShuffleConvLSTM2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='shuffleclstm2d_1', group_size=8)(res3d_featmap)
    clstm2d_2 = keras.layers.ShuffleConvLSTM2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='shuffleclstm2d_2', group_size=8)(clstm2d_1)
  elif clstm_type==GATED:
