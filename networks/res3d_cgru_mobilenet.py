...
def res3d_cgru_mobilenet(inputs, seq_len, weight_decay, cgru_type):
  # Res3D Block
  res3d_featmap = res3d(inputs, weight_decay)

  if cgru_type==SEPARABLE:
    # SeparableConvGRU2D Block
    cgru2d_1 = keras.layers.SeparableConvGRU2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='separablecgru2d_1')(res3d_featmap)
    cgru2d_2 = keras.layers.SeparableConvGRU2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='separablecgru2d_2')(cgru2d_1)
  elif cgru_type==SHUFFLE:
    # ShuffleConvGRU2D Block
    cgru2d_1 = keras.layers.ShuffleConvGRU2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='shufflecgru2d_1', group_size=8)(res3d_featmap)
    cgru2d_2 = keras.layers.ShuffleConvGRU2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='shufflecgru2d_2', group_size=8)(cgru2d_1)
  elif cgru_type==GATED:
    # GatedConvGRU2D Block
    cgru2d_1 = keras.layers.GatedConvGRU2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='gatedcgru2d_1')(res3d_featmap)
    cgru2d_2 = keras.layers.GatedConvGRU2D(256, (3,3), strides=(1,1), padding='same',
                      kernel_initializer='he_normal', recurrent_initializer='he_normal',
                      kernel_regularizer=l2(weight_decay), recurrent_regularizer=l2(weight_decay),
                      return_sequences=True, name='gatedcgru2d_2')(cgru2d_1)
  featmap_2d = keras.layers.Reshape((28,28,256), name='cgru_reshape')(cgru2d_2)
